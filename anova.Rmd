...
```{r two-way with interaction checking assumptions }
plot(diet.aov2_intr)
```
...
```{r Feedback: Boxplots of Average Relative Performance by Feedback}
...
```{r Feedback: Boxplots of Relative Performance by Feedback}
...
```{r Feedback: Boxplots of Average Relative Performance by Feedback and gender}
...
```{r Feedback:Average Relative Performance by Feedback and Time2}
...
```{r Feedback:Average Relative Performance by Feedback and Time}
...
```{r Feedback: interation plot gender and feedback}
...
```{r Feedback: interation plot gender and feedback2}
